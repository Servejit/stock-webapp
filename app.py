...
stockstar_input = st.text_input(
    ...
    "ADANIENT.NS, ADANIPORTS.NS, AMBUJACEM.NS, BAJAJHFL.NS, BHEL.NS, BPCL.NS, BSE.NS, CANBK.NS, COALINDIA.NS, DLF.NS, DMART.NS, GODREJCP.NS, HINDALCO.NS, HINDUNILVR.NS, IRCTC.NS, IRFC.NS, JIOFIN.NS, KOTAKBANK.NS, M.NS, MUTHOOTFIN.NS, NHPC.NS, OIL.NS, PAGEIND.NS, PFC.NS, PNB.NS, POLYCAB.NS, RELIANCE.NS, SOLARINDS.NS, SUZLON.NS, TATACONSUM.NS, TATASTEEL.NS, UPL.NS, YESBANK.NS"
).upper()
